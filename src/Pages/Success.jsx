...
const Success = () => {
  ...
  className="p-4 mb-4 w-4/5 mx-auto text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800 pt-40"
  role="alert"
>
  ...
  <div className="mt-2 mb-4 text-sm">
    You created is Created we will notice you after 24 or 48 hours
  </div>
  <div className="flex">
    <button
      type="button"
